...
@Config
@Autonomous(name = "AutoRR_Right", group = "Robot")
public class AutoRR_Right extends LinearOpMode {
    ...
    public void runOpMode() {
        Pose2d initialPose = new Pose2d(-12, -62, Math.toRadians(90)); //STARTING SPOT
        ...
        //**********************************************************
        //CODE ACTIONS START HERE - PLACE TEAM 9990 AUTO LOGIC HERE - LOGIC FOR AUTO RIGHT
        //
